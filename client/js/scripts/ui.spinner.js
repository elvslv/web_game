	...
	_createButtons: function(input) {
		...
		var self = this,
			...
			wrapper = self.wrapper = input.css({ width: (self.oWidth = (box ? input.width() : input.outerWidth())) - buttonWidth,
				...
				.after( "<span class='ui-spinner ui-widget' style='top:-18px;left:0;'></span>" ).next(),
		...
		icons.css({ marginLeft: (buttons.innerWidth() - icons.width()) / 2 - 0.3, marginTop:  (buttons.innerHeight() - icons.height()) / 2 + 4});
