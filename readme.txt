...
Thank you for purchasing SMALL WORLDS - ALPHA EDITION. 
...
BASIC COMMANDS
	...
	NOTE: every JSON message sent should contain "action" field. Otherwise, 'badJson' error's to be expected.
	...
	~Register
		Format:
			...
			<name> is a 3-16 characters string starting from latin letter. It may contain latin letters, numbers, underlines, hyphens
				   and nothing else
	...
	~doSmth
		...
		Description:
			Does something. Apparently exists for testing purposes only. Return a userId.